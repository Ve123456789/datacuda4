<template>
  <div class="container" >
        ...
        <div class="row clearfix">
          <div class="col-md-6 col-lg-6 offset-6">
            <ul class="btn_group_list_nav">
              ...
              <li><a href="javascript:void(0)" v-on:click="download_project(project_data.id)" v-if="payed === 1">Download</a></li>
              <li><span class="money_text"><b>$ <!--{{ totalAmount(project_data.medias) }}-->{{project_data.share_data.buy_amount}} </b></span></li>
    ...
    <section class="project_client_datat grey_bg">
      <div class="container">
        <div class="row clearfix">
          <div class="col-12 col-md-3 col-sm-6" v-for="img_data in project_data.medias">
            <div class="project__data" v-if="img_data.ext === 'jpg' || img_data.ext === 'png' || img_data.ext === 'gif' ">
              <img :src="project_path.image + img_data.filename" class="project_img__vid" v-img:shared>
            </div>
            <div  class="project__data" v-else-if="img_data.ext === 'mp4' ">
              <div class="imgThumbs">
                ...
                <div class="project_overlay_bg">
                  <div class="center_icon"><img src="/assets/img/play_icon.png" v-on:click="view_video(img_data.id)"></div>
                </div>
              </div>
              <modal :name="'view_video_modal'+img_data.id" height="auto" :scrollable="true">
                <Videos :options="{type: 'video/mp4',src: project_path.file + img_data.filename}"></Videos>
              </modal>
            </div>
          </div>
        </div>
