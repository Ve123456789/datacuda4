                ...
                <div class="file-upload">
                    <div class="form-group btnSec">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                    <p><i class="fa fa-cloud-upload" aria-hidden="true"></i> Project Size : {{project_size.value}}{{project_size.type}}</p>
                            </div>
                            <div class="col-md-2 offset-4">
                                <div class="form-group input-search">
                                    <input type="text" class="search_int" name="search" placeholder="Search" v-model="keywords">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="uploadSection">
                                    <button class="btn btn-primary uploadBtn" @click="submit"> <i class="fa fa-cloud-upload" aria-hidden="true"></i>Upload to storage</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <aside class="side_bar">
                            <div class="project_profile">
                                <span v-if="medias[0]" ><img v-bind:src="image_path+'medium/'+ medias[0].filename" v-img:name class="project_profile_img" width="100%"></span>
                                <span v-else><img v-bind:src="'storage/user_medium/'" v-img:name class="project_profile_img" width="100%"></span>
                                <div class="project_content_wrapper">
                                    <div class="clearfix">
                                        ...
                                        <a href="javascript:void(0)" v-on:click="project_edit()"  ><img src="../../../img/edit.svg" class="edit_icon"></a>
                                            <p>Preview</p>
                                        </div>
                                    </div>
                                </div>
                                <nav>
                                    <ul class="project_profile_nav">
                                        <li><a href="javascript:void(0)" id="tabs1" class="active" v-on:click="tabs(1)"><div class="img__icon"><img src="../../../img/upload.png"></div> <span>Upload files</span></a></li>
                                        <li><a href="javascript:void(0)" id="tabs2"  v-on:click="tabs(2)" ><div class="img__icon"><img src="../../../img/avatar_icon.png"> </div><span>Client information</span></a></li>
                                        <li><a href="javascript:void(0)" id="tabs3" ><div class="img__icon"><img src="../../../img/invoice.png"> </div><span>Invoice details</span></a></li>
                                        <li><a href="javascript:void(0)" id="tabs4" ><div class="img__icon"><img src="../../../img/circular-plus-button-black.png"> </div><span>Additional items</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </aside>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <div class="row detailSec">
                                                <div class="col-md-6 scrollbar" id="style-3">
                                                ...
                                                <div class="col-md-6 dragSec">
                                                    <div class="sec sec-select" id="fileDrag">
                                                        <input type="file"  id="file" multiple="multiple"  @change="uploadFieldChange" >
                                                        <!-- <input type="file" multiple="multiple" id="file" @change="uploadFieldChange"> -->
                                                        <label class="btn_browse" for="file"><img v-bind:src="'/assets/img/add-new.png'"/></label>
                                                    </div>
                                                </div>
                            ...
                            <div class="additional__iteam">
                                <form class="additional_form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row invoice_r_form">
                                                            <div class="col-md-6 col-sm-6 invoice_r_form_1">
                                                                <input type="text" name="First Name" placeholder="First Name" class="form-control" v-model="fist_name" v-validate="'required'">
                                                                <span class="error" v-if="errors.has('First Name')">{{errors.first('First Name')}}</span>
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 input_type_date">
                                                                <input type="text" name="Last Name" placeholder="Last Name" class="form-control" v-model="last_name" v-validate="'required'">
                                                                <span class="error" v-if="errors.has('Last Name')">{{errors.first('Last Name')}}</span>
                                                            </div>
                                                            <div class="col-md-12" ></div>
                                                            <div class="col-md-12 col-sm-12 input_type_date">
                                                                <input type="text" name="Email" placeholder="Email" class="form-control"  v-model="email" v-validate="'required|email'">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row invoice_r_form">
                                                            <div class="col-md-6 col-sm-6 invoice_r_form_1">
                                                                <input type="text" name="Address" placeholder="Address" class="form-control" v-model="address" v-validate="'required'">
                                                                <span class="error" v-if="errors.has('Address')">{{errors.first('Address')}}</span>
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 input_type_date">
                                                                <input type="text" name="City" placeholder="City" class="form-control" v-model="city" v-validate="'required'">
                                                                <span class="error" v-if="errors.has('City')">{{errors.first('City')}}</span>
                                                            </div>
                                                            <div class="col-md-12"></div>
                                                            <div class="col-md-6 col-sm-6 invoice_r_form_1">
                                                                <input type="text" name="State" placeholder="State" class="form-control" v-model="state" v-validate="'required'">
                                                                <span class="error" v-if="errors.has('State')">{{errors.first('State')}}</span>
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 input_type_date">
                                                                <input type="text" name="Zip" placeholder="Zip" class="form-control" v-model="zip" v-validate="'required'">
                                                                <span class="error" v-if="errors.has('Zip')">{{errors.first('Zip')}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <ul class="form_btn_list">
                                        <li><a href="javascript:void(0)" v-on:click="valid_tabs(3)">Next</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        <div style="display: none" id="tabs_show3">
                            <div class="additional__iteam">
                                <form class="additional_form">
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row invoice_r_form">
                                                            <div class="col-md-6 col-sm-6 invoice_r_form_1">
                                                                <input type="text" name="Invoice No" placeholder="Invoice no." class="form-control" v-model="invoice_no" v-validate="'required'">
                                                                <span class="error" v-if="errors.has('Invoice No')">{{errors.first('Invoice No')}}</span>
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 input_type_date">
                                                                <input type="date" name="Invoice Date" class=" form-control" v-model="invoice_date" v-validate="'required'">
                                                                <span class="error" v-if="errors.has('Invoice Date')">{{errors.first('Invoice Date')}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row invoice_r_form">
                                                            <div class="col-md-5 col-sm-6 invoice_r_form_1">
                                                                <input type="text" name="Description" placeholder="Description" class="form-control invoice_des" value="Project Amount" readonly v-validate="'required'">
                                                                <span class="error" v-if="errors.has('Description')">{{errors.first('Description')}}</span>
                                                            </div>
                                                            
                                                            <div class="col-md-3 col-sm-3 input_type_date">
                                                                <input type="number" name="Amount"  placeholder="320.00" class="form-control invoice_amount"   v-validate="'required'">
                                                                <span class="error" v-if="errors.has('Amount')">{{errors.first('Amount')}}</span>
                                                            </div>

                                                            <div class="col-md-3 col-sm-3 input_type_currency">
                                                                <select name="Amount Type"  class="form-control invoice_amount_type"  v-validate="'required'">
                                                                    <option value="USD" selected >USD</option>
                                                                </select>
                                                                <span class="error" v-if="errors.has('Amount Type')">{{errors.first('Amount Type')}}</span>
                                                            </div>
                                                            <div class="col-md-1 col-sm-1 input_type_currency" v-if="add_invoice_val === add_invoice_loop && add_invoice_val !== 1">
                                                                <span class="btn btn-danger btn-sm" style="height: auto" v-on:click="remove_add_invoice()"><i class="fa fa-times" aria-hidden="true" ></i></span>
                                                            </div>
                                                        </div>
                                                        <div v-for="add_invoice_val in add_invoice_loop" v-if="add_invoice_val !== 1">
                                                        <div class="row invoice_r_form">
                                                            <div class="col-md-5 col-sm-6 invoice_r_form_1">
                                                                <input type="text" :name="'Description '+ add_invoice_val" placeholder="Description" class="form-control invoice_des"  v-validate="'required'" >
                                                                <span class="error" v-if="errors.has('Description '+add_invoice_val)">{{errors.first('Description '+add_invoice_val)}}</span>
                                                            </div>
                                                            <div class="col-md-3 col-sm-3 input_type_date">
                                                                <input type="number" :name="'Amount '+ add_invoice_val"  placeholder="320.00" class="form-control invoice_amount" v-validate="'required'" >
                                                                <span class="error" v-if="errors.has('Amount '+add_invoice_val)">{{errors.first('Amount '+add_invoice_val)}}</span>
                                                            </div>
                                                            <div class="col-md-3 col-sm-3 input_type_currency">
                                                                <select :name="'Amount Type '+ add_invoice_val"  class="form-control invoice_amount_type"  v-validate="'required'">
                                                                <option value="USD" selected >USD</option>
                                                                </select>
                                                                <span class="error" v-if="errors.has('Amount Type '+add_invoice_val)">{{errors.first('Amount Type '+add_invoice_val)}}</span>
                                                            </div>
                                                            <div class="col-md-1 col-sm-1 input_type_currency" v-if="add_invoice_val === add_invoice_loop">
                                                                <span class="btn btn-danger btn-sm" style="height: auto" v-on:click="remove_add_invoice()"><i class="fa fa-times" aria-hidden="true" ></i></span>
                                                            </div>
                                                        </div>
                                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="add_line_iteam" v-on:click="add_invoice()">
                                                            <img src="../../../img/add_line_iteam.png" alt=""> <span>Add line item</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group text__area">
                                                <textarea placeholder="Enter your message" class="form-control" cols="30" rows="5" name="Message" v-model="massage" v-validate="'required'"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="yes_no_btn">
                                                <div class="inputGroup">
                                                    <input id="option1" name="option1" type="radio" value="1"  v-model="collect_payment"/>
                                                    <label for="option1">Yes</label>
                                                </div>
                                                <div class="inputGroup">
                                                    <input id="option2" name="option1" type="radio" value="0"  v-model="collect_payment"/>
                                    ...
                                    <ul class="form_btn_list">
                                        <li><a href="javascript:void(0)" v-on:click="tabs(2)" >Back</a></li>
                                        <li><a href="javascript:void(0)" v-on:click="valid_tabs(4)" >Next</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" placeholder="Password" v-model="set_password">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="buttons__form_group">
                                        <div class="form-group ckeck_box">
                                            ...
                                            <input type="checkbox" id="switch" v-model="include_condition" /><label for="switch">Toggle</label>
                                        </div>
                                    </div>
                                    <div class="buttons__form_group" style="display:none;">
                                        <div class="form-group ckeck_box">
                                            <span class="label__text">Project According Amount</span>
                                            <input type="checkbox" id="accordingamount" v-on:change="ChangeProjectAccording()"/><label for="accordingamount">Toggle</label>
                                            <span style="margin-left:40px"></span><span class="label__text">Image According Amount</span>
                                            <input type="text" id="projectamount" :value="project_data.project_price" class="form-control" v-on:focusout="ChangeProjectAccordingAmount()">
                                        </div>
                                    </div>
                                    <div class="buttons__form_group">
                                        <div class="form-group">
                                            <span class="radio_btn_label">Send as: </span>
                                            <div class="radio_btn" v-on:click="mail_mex()" v-if="project_size.mail_size === 0">
                                                <span>E-mail</span>
                                            ...
                                            <div class="radio_btn" v-else>
                                                <span>E-mail</span>
                                                <input type="radio" id="test1" name="radio-group" value="email" v-model="send_as" >
                                                <label for="test1"></label>
                                            </div>
                                            <div class="radio_btn">
                                                <span>Link</span>
                                                <input type="radio"  id="test2" name="radio-group" value="link" v-model="send_as">
                                                <label for="test2"></label>
                                            </div>
                                        </div>
                                    </div>
                                    <ul class="form_btn_list">
                                        <li><a href="javascript:void(0)" v-on:click="tabs(3)">Back</a></li>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            tabs(id)
            {
                if(id === 1){$('#tabs1').addClass('active');$('#tabs_show1').show();}
                else {$('#tabs1').removeClass('active');$('#tabs_show1').hide();}
                if(id === 2){$('#tabs2').addClass('active');$('#tabs_show2').show();}
                else {$('#tabs2').removeClass('active');$('#tabs_show2').hide();}
                if(id === 3){$('#tabs3').addClass('active');$('#tabs_show3').show();}
                else {$('#tabs3').removeClass('active');$('#tabs_show3').hide();}
                if(id === 4){$('#tabs4').addClass('active');$('#tabs_show4').show();}
                else {$('#tabs4').removeClass('active');$('#tabs_show4').hide();}
            },
