...
<div>
		...
		<section class="dashboard__filter">
			<div class="d_container container">
				<div class="row clearfix">
					...
					<div class="col-md-2 col-lg-2">
						<p><i class="fa fa-database" aria-hidden="true"></i> Disk Usage : {{datausag.value}}{{datausag.type}} <i class="fa fa-pie-chart" aria-hidden="true"></i> Plan : {{usagedata.plan}}</p>
					</div>
					<div class="col-md-4 col-lg-8">
						<ul class="project_p_ost btn_group_list_nav">
							<li>
							...
							<li><a href="javascript:void(0)" @click="show">create project </a></li>
							<li><a href="javascript:void(0)" @click="submit" ><i class="fa fa-cloud-upload" aria-hidden="true"></i> UPLOAD STORAGE </a></li>
						</ul>
					</div>
				</div>
			</div>
        ...
        <div class="form_content_box">
            ...
            <flash-message class="myCustomClass"></flash-message>
            <button type="button" class="close" aria-label="Close"  @click="hide"> Close </button>
            ...
            <div class="form-group">
                <button class="btn big_btn" @click="createProject">Create</button>
            </div>
        </div>
        </div>
    </modal>
