...
<!-- 
                    ...
                    <div class="left-content payment_content" >
                        ...
                        <div class="table-responsive max-height">
                          <table class="payment_table table">
                            <tbody>
                              <tr v-for="img_data in project_data.medias" v-bind:key="img_data.id">
                      ...
                      <div class="expir_Cvv form-group">
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-3">
                            <input type="text" placeholder="00" class="form-control" v-model="month"></div>
                          <div class="col-sm-6 col-3">
                            <input type="text" placeholder="00" class="form-control" v-model="year"></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-3 col-3">
    ...
    <modal name="payment_modal"  :scrollable="false" draggable=".window-header">
      <div class="payments_wrapper">
        <div class="payments_main_box">
          <div class="row">
            <div class="payment_left_content col-lg-7 col-md-12" style="overflow-x:auto">
            ...
            <div class="payment_right_content white_bg col-lg-5 col-md-12">
              <form class="payment_form_data">
                <h2> Payment</h2>
                <div class="fail_payment">
                </div>
